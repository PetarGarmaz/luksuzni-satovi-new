  ...
  hr: {
    ...
    about: {
      ...
      benefits: [
        ...
        'Profesionalni otkup satova i otkup rabljenih satova po fer cijenama',
        'Široka ponuda luksuznih rabljenih satova prestižnih brendova',
        'Stručna procjena i transparentna kupnja-prodaja satova s potpunom sigurnošću'
      ]
    },
    ...
    contact: {
      ...
      benefits: [
        ...
        'Besplatna procjena vrijednosti',
    ...
    // Catalog Page
    catalog: {
      title: 'Prodaja satova',
      subtitle: 'Pregledajte našu kompletnu kolekciju luksuznih satova prestižnih svjetskih brendova',
      back: 'Povratak',
      search: 'Pretraži satove...',
      category: 'Kategorija',
      brand: 'Brend',
      sort: 'Sortiraj',
      sortOptions: {
    ...
    otkup: {
      ...
      form: {
        ...
        documentationOptions: {
          yes: 'Da, imam svu dokumentaciju',
          partial: 'Imam dio dokumentacije',
          no: 'Ne, nemam dokumentaciju',
          unsure: 'Nisam siguran'
        },
        images: {
