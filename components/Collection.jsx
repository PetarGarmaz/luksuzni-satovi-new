    ...
    <section id="collection" className="py-20 px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-light text-gray-900 mb-4 uppercase">{t.collection.title}</h2>
        ...
        {featuredWatches.length > 0 ? (
          <>
            <div className="relative">
              ...
              <div id="featured-scroll" className="overflow-x-scroll pb-4 scrollbar-hide">
                <div className="flex gap-6 min-w-max px-16">
                {featuredWatches.map((watch) => (
                  <Link key={watch.id} href={`/prodaja-satova/${watch.slug}`} className="block group cursor-pointer flex-shrink-0 w-80 max-lg:w-56">
